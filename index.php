    ...
    <div class="main-content">
      <section class="blog-list">
        <div class="post">
          <a href="/post.html">
            <img
              src="https://placekitten.com/600/350"
              alt=""
          ...
          >
          <p class="excerpt">
            Wh-what is-h-how did you get my espresso machine? John, if The
        ...
        <div class="post" id="section-2">
          ...
          <span class="date">June 1, 2020</span>
          <a href="#" class="tag tag-orange"
            ><i class="fas fa-tag"></i> Piano</a
          >
          <a href="#" class="tag tag-blue"><i class="fas fa-tag"></i> Vocals</a>
          <p class="excerpt">
            Wh-what is-h-how did you get my espresso machine? John, if The
            Pirates of the Caribbean breaks down, the pirates don’t eat the
            tourists.
